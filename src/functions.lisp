...
(defun cartesian-product (list &rest more-lists)
  "(CARTESIAN-PRODUCT list &rest more-lists) => list1 x list2 x list3 ...
   ...
   Example:
   MATLISP-UTILS> (cartesian-product '(0 1) '(0 1)  '(0 1))
...
(defun binary-search (val lb ub vec &key (order #'<) (test #'=))
  ...
  MATLISP-UTILS> (binary-search 1.2 0 2 #(1 5 8 19))
  1
  NIL
  MATLISP-UTILS> (binary-search 9 0 2 #(1 5 8 19))
  NIL
  2
  MATLISP-UTILS> (binary-search 8 0 2 #(1 5 8 19))
  NIL
  2
  M>
  MATLISP-UTILS> (binary-search 5 0 2 #(1 5 8 19))
  1
  T"
...
(defun sort-index (seq predicate &key key)
  ...
  MATLISP-UTILS> (sort-index #(2 3 1 4 5) #'<)
  #(1 2 3 4 5)
  #(2 0 1 3 4)"
